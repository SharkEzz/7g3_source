...
static bool goodix_init_panel(struct goodix_ts_data *ts)
{
    ...
    if((800 == screen_max_x) && (480 == screen_max_y)){
        ...
        //an7g3                              
         /*uint8_t data_info[54] = {0x0F,0x05,0x05,0x28,0x02,0x14,0x14,0x10,0x41,0xB2,0x14,0x00,0x1E,0x00,0xED,0xCB,
         				   0xA9,0x87,0x65,0x43,0x21,0x00,0x00,0x00,0x35,0x2E,0x4D,0xC1,0x20,0x01,0x01,0x83,
         				   0x00,0x00,0x00,0xB4,0x00,0x33,0x2C,0x01,0xEC,0x00,0x5F,0x00,0x00,0x00,0x00,0x00,
         				   0x00,0x00,0x00,0x00,0x01};*/
        for(i =0; i < 54; i++){
